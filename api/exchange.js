...
class Exchange {
    ...
    */
	...
	static getExchangeCoinRate(data){
		return Serve.get("/wallet/getExchangeCoinRate",data)
	}
	// 币种列表
	static getCoinList(data){
		return Serve.get("/wallet/getExchangeCoinList",data)
	}
	// 获取闪兑记录
	static getExchangeRecord(data){
		return Serve.get("/wallet/getExchangeCoinRecord",data)
	}
	// 提交闪兑
	static submitExchange(data){
		return Serve.post("/wallet/submitExchangeCoin",data)
	}
